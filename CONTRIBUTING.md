...
There are guidelines for some parts of the project — see [RELEASING.md](RELEASING.md) for the release procedure. For everything else, try to maintain the current code and documentation style.
